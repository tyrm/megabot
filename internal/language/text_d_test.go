...
func TestTextDashboard(t *testing.T) {
	langMod, _ := New()
	...
	tables := []struct {
		...
		{language.English, "Dashboard", language.English},
		{language.Spanish, "Dashboard", language.English},
		{language.Hindi, "Dashboard", language.English},
	}
	...
	for i, table := range tables {
		...
		t.Run(name, func(t *testing.T) {
			...
			result := localizer.TextDashboard()
